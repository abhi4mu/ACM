...
create table STUDENT_YEARS(STUDENT_SNO INT, START_YEAR varchar(4), END_YEAR varchar(4), TITLE INT, CLUB INT);
ALTER TABLE STUDENT_YEARS ADD foreign key (STUDENT_SNO) REFERENCES STUDENT_MEMBERS(SNO); 

CREATE TABLE FACULTY_MEMBERS(SNO INT, ID VARCHAR(20), FACULTY_NAME VARCHAR(30), IMAGE_AVAILABLE INT, GENDER CHAR, LINK varchar(500), primary key (SNO,ID));
create table FACULTY_YEARS(FACULTY_SNO INT, START_YEAR varchar(4), END_YEAR varchar(4), TITLE VARCHAR(30));
